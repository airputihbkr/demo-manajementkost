...
export const Header = () => {
    return (
        <div className="max-w-7xl relative mx-auto py-20 md:py-40 px-4 w-full left-0 top-0 flex flex-col md:flex-row justify-between items-start z-50 pointer-events-auto">
            <div>
            ...
            <div className="mt-8 md:mt-0 flex flex-col items-end">
                <p className="text-sm text-neutral-400 mb-2 font-light italic">
                    Ingin melihat demo Dashboard Pemilik?
                </p>
                <Link to="/login" className="inline-flex h-12 animate-shimmer items-center justify-center rounded-md border border-slate-800 bg-[linear-gradient(110deg,#000103,45%,#1e2631,55%,#000103)] bg-[length:200%_100%] px-6 font-medium text-slate-400 transition-colors focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50">
                    Login Pemilik
                </Link>
            </div>
        </div>
